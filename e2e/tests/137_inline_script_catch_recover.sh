...
e2e::assert_contains "${recover_out}" "PASS def main" "workflow passes after recover retries"
...
e2e::assert_contains "${rule_out}" "PASS def main" "rule with inline-script catch passes"
