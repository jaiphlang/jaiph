...
e2e::assert_equals "${formatted}" 'export def main() {
  log "hello"
...
e2e::assert_equals "${formatted2}" 'export def main() {
  log "hello"
...
e2e::assert_equals "${unformatted_after}" 'export def main()   {
  log "hello"
...
e2e::assert_equals "${indent4}" 'export def main() {
    log "hello"
...
e2e::assert_equals "${blank_out}" 'export def main() {
  log "first"
