...
.jaiph::docs_parity::rule::docs_files_present::impl() {
  set -eo pipefail
  set +u
  test "$#" -gt 0
  EXPECTED_DOC_FILES=("$@")
...
.jaiph::docs_parity::rule::docs_files_present() {
  jaiph::run_step .jaiph::docs_parity::rule::docs_files_present jaiph::execute_readonly .jaiph::docs_parity::rule::docs_files_present::impl "$@"
}

.jaiph::docs_parity::rule::only_expected_docs_changed_after_prompt::impl() {
  set -eo pipefail
  set +u
  test "$#" -eq 2
...
.jaiph::docs_parity::rule::only_expected_docs_changed_after_prompt() {
  jaiph::run_step .jaiph::docs_parity::rule::only_expected_docs_changed_after_prompt jaiph::execute_readonly .jaiph::docs_parity::rule::only_expected_docs_changed_after_prompt::impl "$@"
}

.jaiph::docs_parity::rule::tests_pass::impl() {
  set -eo pipefail
  set +u
  npm test
}

.jaiph::docs_parity::rule::tests_pass() {
  jaiph::run_step .jaiph::docs_parity::rule::tests_pass jaiph::execute_readonly .jaiph::docs_parity::rule::tests_pass::impl "$@"
}

.jaiph::docs_parity::rule::e2e_tests_pass::impl() {
  set -eo pipefail
  set +u
  npm run test:e2e
}

.jaiph::docs_parity::rule::e2e_tests_pass() {
  jaiph::run_step .jaiph::docs_parity::rule::e2e_tests_pass jaiph::execute_readonly .jaiph::docs_parity::rule::e2e_tests_pass::impl "$@"
}

.jaiph::docs_parity::function::changed_files::impl() {
  set -eo pipefail
  set +u
  {
  git diff --name-only
...
.jaiph::docs_parity::function::changed_files() {
  jaiph::run_step_passthrough .jaiph::docs_parity::function::changed_files .jaiph::docs_parity::function::changed_files::impl "$@"
}
...
.jaiph::docs_parity::workflow::default::impl() {
  set -eo pipefail
  set +u
  EXPECTED_DOC_FILES=(
  "README.md"
  ...
  .jaiph::docs_parity::rule::tests_pass
  .jaiph::docs_parity::rule::e2e_tests_pass
  .jaiph::docs_parity::rule::docs_files_present "${EXPECTED_DOC_FILES[@]}"
...
__JAIPH_PROMPT_79__
  ...
  .jaiph::docs_parity::rule::only_expected_docs_changed_after_prompt "$EXPECTED_DOC_FILES_TEXT" "$BEFORE_CHANGED_FILES"
  .jaiph::docs_parity::rule::tests_pass
  .jaiph::docs_parity::rule::e2e_tests_pass
}

.jaiph::docs_parity::workflow::default() {
  jaiph::run_step .jaiph::docs_parity::workflow::default .jaiph::docs_parity::workflow::default::impl "$@"
}