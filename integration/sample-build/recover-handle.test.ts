  ...
  try {
    writeFileSync(
      ...
      [
        ...
        "}",
        "export def main() {",
        "  const ha = async make_a()",
        "  const hb = async make_b()",
        "  combine(ha, hb)",
        "}",
        "",
      ].join("\n"),
  ...
  try {
    writeFileSync(
      ...
      [
        ...
        "}",
        "export def main() {",
        "  const h1 = async first()",
        "  const h2 = async second()",
...
test("handle: async foo() recover — handle resolves to success after repair", () => {
