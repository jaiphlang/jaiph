export function printUsage(): void {
  process.stdout.write(
    [
      ...
      "  jaiph report [start|stop|status] [options]",
      "",
      ...
      "",
      "jaiph report:",
      "  Run  jaiph report --help  for commands (start|stop|status) and options (--host, --port, --poll-ms,",
      "  --runs-dir, --workspace, --pid-file). Environment variables JAIPH_REPORT_* mirror those flags.",
      "",
      "Examples:",
      "  jaiph --help",
      "  jaiph --version",
